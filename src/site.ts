...
<div class="wrap">
  ...
  <div class="prose">
    ...
    <ul>
      ...
      <li>No third-party scripts, fonts, or trackers. The only external resource is the <a href="https://yoke.lol/open-distance.com" target="_blank" rel="noopener">Yoke</a> reputation badge in the footer (same maintainer as this project). Yoke logs nothing beyond <a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener">Cloudflare's standard privacy-aware metrics</a> and treats IPs as GDPR-protected data; the badge SVG itself is unauthenticated. Full details on <a href="https://yoke.lol/privacy" target="_blank" rel="noopener">Yoke's privacy page</a>. Block <code>yoke.lol</code> in your browser if you'd rather; the page still works.</li>
